...
import { LANGFUSE_HOST, LANGFUSE_PUBLIC_KEY, LANGFUSE_SECRET_KEY, SILICONFLOW_API_KEY, SILICONFLOW_BASE_URL } from "@/constants/llm";
...
export const modelMapping = {
    "deepseek-chat": "Pro/deepseek-ai/DeepSeek-V3",
    "deepseek-reasoner": "Pro/deepseek-ai/DeepSeek-R1",
}
...
export async function chat({ messages, model: sourceModel, tools, ...rest }: IChatRequest, userId?: string) {
    ...
    const openai = observeOpenAI(client, {
        generationName: 'siliconflow.' + model,
        userId,
        clientInitParams: {
