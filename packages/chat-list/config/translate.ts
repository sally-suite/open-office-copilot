export const SHEET_CHAT_TO_LANG = 'sheet-chat-to-lang';
export const SHEET_CHAT_FROM_LANG = 'sheet-chat-from-lang';
export const SHEET_CHAT_TRANSLATE_ENGINE = 'sheet-chat-translate-engine';
