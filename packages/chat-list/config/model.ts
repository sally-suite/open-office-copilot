...
export const ModelTip: any = {
    ...
    'deepseek-reasoner': ['STANDARD+', 'Slow'],
    'gpt-4o': ['BASIC+', ' Fast'],
    'o1-mini': ['STANDARD+', 'Slow'],
    'o3-mini': ['STANDARD+', 'Slow'],
...
export const ModelIcon: any = {
    ...
    'deepseek-reasoner': deepseekLogo,
}
...
export const IsSupportSystemRoleModel = (model = '') => {
    const name = model.toLowerCase();
    if (name.includes('o1') || name.includes('o3') || name.includes('deepseek-reasoner')) {
        return false;
    }
    return true;
}
