...
export default function ToolList() {
    ...
    const { plugin, setAgentTools, chat, appendMsg, setTyping, setPlaceholder, showMessage, setDataContext } = useChatState();
    ...
    const callTool = async (item: any) => {
        ...
        if (item.code == 'translate') {
            ...
            const promptTpl = promptSetting[item.prompt || item.code];
